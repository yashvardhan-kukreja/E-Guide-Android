...
public class TeacherHomeSettingsFragment extends Fragment {
    ...
    public TeacherHomeSettingsFragment(Context context) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_teacher_settings, container, false);

        logout = rootView.findViewById(R.id.teacher_setting_logout);
        about = rootView.findViewById(R.id.teacher_setting_about);
